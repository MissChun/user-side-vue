export default {
  ...
  component: resolve =>
    require(['../page/servicePackageManage/servicePackageManage'], resolve),
  children: [
    {
      ...
      component: resolve =>
        require([
          '../page/servicePackageManage/healthServicePackage/healthServicePackage'
        ], resolve),
      children: [
        {
          ...
          component: resolve =>
            require([
              '../page/servicePackageManage/healthServicePackage/servicePackList'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/servicePackageManage/healthServicePackage/servicePackEdit'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/servicePackageManage/healthServicePackage/servicePackDetail'
            ], resolve)
        }
      ]
    },
    {
      ...
      component: resolve =>
        require([
          '../page/servicePackageManage/experienceProjectManage/experienceProjectManage'
        ], resolve),
      children: [
        {
          ...
          component: resolve =>
            require([
              '../page/servicePackageManage/experienceProjectManage/experienceProjectList'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/servicePackageManage/experienceProjectManage/settlementPriceEdit'
            ], resolve)
        }
      ]
    }
