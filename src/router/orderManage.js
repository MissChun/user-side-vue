  ...
  children: [
    {
      ...
      component: resolve =>
        require(['../page/orderManage/physicalOrder/physicalOrder'], resolve),
      children: [
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/physicalOrder/physicalOrderList'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/physicalOrder/physicalOrderEdit'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/physicalOrder/physicalOrderDetail'
            ], resolve)
        }
      ]
    },
    {
      ...
      component: resolve =>
        require(['../page/orderManage/healthOrder/healthOrder'], resolve),
      children: [
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/healthOrder/healthOrderList'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/healthOrder/healthOrderEdit'
            ], resolve)
        },
        {
          ...
          component: resolve =>
            require([
              '../page/orderManage/healthOrder/healthOrderDetail'
            ], resolve)
        }
      ]
    }
